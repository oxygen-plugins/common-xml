package com.nkutsche.common.xml.xsd;
...
import com.nkutsche.common.xml.exceptions.ValidationSummaryException;
...
//		domp.setFeature("http://apache.org/xml/features/xinclude", true);
	...
	public Xerces(String namespace, File schema) throws SAXNotRecognizedException, SAXNotSupportedException, MalformedURLException {
		...
		this.schema = schema.getAbsolutePath();
	}
	...
	public Xerces(String namespace, Source schema) throws SAXNotRecognizedException, SAXNotSupportedException, MalformedURLException {
		...
		this.schema =schema.getSystemId();
	}
...
//		}
		...
		if(this.errorList.size() > 0)
			throw ValidationSummaryException.createValidationSummary("Schema error(s) in the instance " + instanceFile + "\n" +
					"schema: " + schema + ": ", this.errorList, instanceFile);
